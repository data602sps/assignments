# -*- coding: utf-8 -*-
"""
Created on Sun Oct 18 16:32:43 2020
...
def exercise13(n):
    ...
    '''
    # ------ Place code below here \/ \/ \/ ------
    date_range = pd.date_range('1/1/2010', period = n, freq = 'H')
...
def exercise14(words):
    ...
    '''
    # ------ Place code below here \/ \/ \/ ------
    df = pd.DataFrame([[5, 3, 3]] * 3, columns=['hello', 'car', 'bye'])
